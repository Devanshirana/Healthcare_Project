...
def predict():
    try:
        ...
        predicted_disease = diseases_list[disease_code]
        ...
        meds = medications[medications['Disease'] == predicted_disease]['Medication'].values[0]
        diet = diets[diets['Disease'] == predicted_disease]['Diet'].values[0]
        workouts = workout[workout['disease'] == predicted_disease]['workout'].values
